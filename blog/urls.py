...
from blog.views import (
    ...
    PostCreateView,
    PostsListView, BloggerPostDestroyView,
    PostRetrieveView, BloggerPostUpdateView,
    AddCommentView,
    AddLikeView
)
...
urlpatterns = [
    ...
    path("post/<uuid:pid>/delete-post", BloggerPostDestroyView.as_view(lookup_field="uuid")),
